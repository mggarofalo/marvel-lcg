...
class Log:
    ...
    CATEGORY = Literal["UPLOAD", "GAME", "WEB", "ENGINE", "STATISTICS", "SCENE", "TEST", "CHEAT", "EDITOR", "CONTROLLER", "CACHE", "EFFECT", "SELECTOR", "REPLAY", "PLAYER", "SENDER", "RENDER", "VERSION", "THREADS", "LOG", "NOTIFY", "LOAD", "DEVICE_MANAGER", "WEB_DEVICE_MANAGER", "JSON", "CONTROLLER_MANAGER", "TASK", "COMMAND", "PUZZLE", "ALL", "SERVER_CONFIG", "SYNC", "NEW", "RANDOM", "CHECK_NEW_VERSION", "UNIT_TEST", "FILE", "CONSOLE", "JOB", "GAME_STATE", "SKIP", "SESSION", "FAST_UNDO", "MESSAGE", "UNDO_HANDLE", "BOT", "COVERAGE"]
