...
| Tests | `and`, `or`, `not`, `exists`, `hasStatus`, `hasTrait`, `isTitle`, `inForm`, `atLeast`, `titleInPlay`, `attackDamaged`, `discardedWithResource`, `defeatedByYou`, `wasDefeated`, `heroDefended`, `inExpertMode`, `isKind`, `defeatedBy` |
