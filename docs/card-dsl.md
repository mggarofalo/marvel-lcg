...
| Tests | `and`, `or`, `not`, `exists`, `hasStatus`, `hasTrait`, `isTitle`, `inForm`, `atLeast`, `titleInPlay`, `attackDamaged`, `inExpertMode`, `isKind`, `defeatedBy` |
| Actions | `giveStatus`, `attachTo`, `discard`, `draw`, `drawToHandSize`, `dealEncounterCards`, `grant`, `grantUntil`, `delayUntil`, `gainSurge`, `enemyAttacks`, `enemySchemes`, `dealDamage`, `placeThreat`, `removeThreat`, `preventThreatRemoval`, `heal`, `search`, `exhaust`, `ready`, `revealTop`, `reveal`, `shuffleInto`, `shuffle`, `discardUntil`, `discardAtRandom`, `changeForm`, `removeFromGame`, `indirectDamage`, `placeAtRandom`, `putIntoPlay`, `returnToHand`, `soakDamage`, `generate`, `doubleResourceFor` |
...
| Dynamic amounts | `count`, `damageOn`, `discardedWithResource`, `modified`, `perPlayer`; arithmetic `min`, `add`, `mul`; conditional `if` |
| Players | `you`, `controller`, `trigger.player`, and `chosenPlayer` after choosing an identity |
