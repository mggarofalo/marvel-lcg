...
| Disposition | Records |
|---|---:|
| Executable and cited | 410 |
| Covered by a narrower rule | 54 |
| Redirect or summary | 102 |
| Not enforceable by an engine | 33 |
| Outside the supported product boundary | 71 |
| Unimplemented behavior | 548 |
| Total | 1,218 |
...
MARVEL-268, MARVEL-269, MARVEL-270, MARVEL-271, MARVEL-272, and MARVEL-275 are in the Rules Reference Coverage module. MARVEL-254 records the one known ordering gap outside those broad work items.
...
| `rr:ability.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ability.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ability.3.1` | Not enforceable by an engine | — | This record is an example, not a separate game-state decision. |
| `rr:ability.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:ability.7.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ability.8` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:ability.8.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ability.8.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:ability.12` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ability.13` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ability.14` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:action.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:action.1.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:action.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:action.2.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:action.2.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:activation.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:activation.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:activation.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:activation.5` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:activation.8.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:activation.8.2` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:active-player` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:alliance.1` | Outside the supported product boundary | MARVEL-272 | This rule belongs to deckbuilding, a mode, or a product classification not yet supported. |
| `rr:alliance.2` | Outside the supported product boundary | MARVEL-272 | This rule belongs to deckbuilding, a mode, or a product classification not yet supported. |
...
| `rr:ally.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:alteration-effect` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:alteration-effect.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:and` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:and.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:and.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:attachment` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:basic-power` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:basic-power.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:basic-power.1.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:basic-power.1.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:basic-power.1.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:basic-power.1.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:basic-power.1.5` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:cannot.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:cannot.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:card-types.1` | Covered by a narrower rule | — | The dedicated player-card type entries state these classifications more precisely. |
| `rr:card-types.2` | Covered by a narrower rule | — | The dedicated encounter-card type entries state these classifications more precisely. |
...
| `rr:cost-arrow-icon.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:deck` | Unimplemented behavior | MARVEL-271 | The search, movement, and lifecycle work item owns this executable rule. |
...
| `rr:draw-drawing-cards.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:draw-drawing-cards.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:encounter-card` | Covered by a narrower rule | — | The eight dedicated encounter-card type entries state this list more precisely. |
...
| `rr:end-of-player-phase.step.5` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:energy-resource` | Unimplemented behavior | MARVEL-269 | Resource-type behavior exists; the citation work item must attach this narrow definition to its proof. |
| `rr:energy-resource.1` | Unimplemented behavior | MARVEL-269 | Resource payment exists; the citation work item must attach this narrow clause to its proof. |
| `rr:energy-resource.2` | Unimplemented behavior | MARVEL-269 | Typed resource requirements exist; the citation work item must attach this narrow clause to its proof. |
...
| `rr:event` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:first-player.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:flip.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:flip.2.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:flip.2.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:for-each` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:for-each.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:for-each.1.1` | Not enforceable by an engine | — | This record is an example, not a separate game-state decision. |
| `rr:for-each.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:for-each.3` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:for-each.3.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:for-each.3.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:forced.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:form-change-form.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:form-change-form.6.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:form-change-form.7` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:friendly` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:gains` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:hand-size.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:identity.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:in-play-and-out-of-play.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.5` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:in-play-and-out-of-play.6` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.7` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.8` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.9` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.10` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.11` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:in-play-and-out-of-play.12` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:initiating-abilities.step.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:initiating-abilities.step.6` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:initiating-abilities.step.7` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:initiating-abilities.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:initiating-abilities.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:interrupt.1.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:interrupt.2` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:interrupt.2.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:keywords.1` | Redirect or summary | — | This overview lists rules that the dedicated glossary entries state precisely. |
...
| `rr:labeled-ability` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.3` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.3.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.4` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.5` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.6` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.6.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:labeled-ability.6.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:lasting-effects.6` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:limit.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:linked-card-title.3` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:linked-card-title.3.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:linked-card-title.4` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:loses` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:loses.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:loses.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:mental-resource.2` | Unimplemented behavior | MARVEL-269 | Typed resource requirements exist; the citation work item must attach this narrow clause to its proof. |
...
| `rr:minion.3` | Executable and cited | — | A behavior test directly cites this record. |
...
| `rr:modes-of-play.1` | Outside the supported product boundary | MARVEL-272 | This rule belongs to deckbuilding, a mode, or a product classification not yet supported. |
...
| `rr:otherwise` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:otherwise.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:otherwise.1.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:otherwise.1.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:ownership-and-control.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:ownership-and-control.2.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ownership-and-control.3` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:ownership-and-control.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ownership-and-control.5` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:ownership-and-control.6` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:ownership-and-control.7.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ownership-and-control.7.2` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:ownership-and-control.7.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ownership-and-control.7.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ownership-and-control.8` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:permanent.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:permanent.2` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:permanent.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:permanent.6` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:physical-resource` | Unimplemented behavior | MARVEL-269 | Resource-type behavior exists; the citation work item must attach this narrow definition to its proof. |
| `rr:physical-resource.1` | Unimplemented behavior | MARVEL-269 | Resource payment exists; the citation work item must attach this narrow clause to its proof. |
| `rr:physical-resource.2` | Unimplemented behavior | MARVEL-269 | Typed resource requirements exist; the citation work item must attach this narrow clause to its proof. |
...
| `rr:play-put-into-play.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:play-put-into-play.5` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-deck.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-elimination.step.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-elimination.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:player-elimination.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:player-elimination.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-elimination.5.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-phase.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-turn.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-turn.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:player-s-play-area.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:player-s-play-area.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:player-s-play-area.3` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:player-s-play-area.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:player-s-play-area.5` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:player-s-play-area.6` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:ready.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:ready.1.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:referential-ability` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:referential-ability.step.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:resolve.3` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:resolve.4` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:resolve.5` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:resolve.6` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:resolve.7` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:resolve.8` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:resource-card.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:resource-card.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:response.1.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:response.2` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:response.2.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:response.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:response.4` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:restricted` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:restricted.1` | Executable and cited | — | A behavior test directly cites this record. |
...
| `rr:support` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:support.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:support.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:target.2.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.2.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.2.3` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:target.3.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.3.3` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.3.4` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.3.5` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.3.6` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.3.7` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.3.8` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.3.9` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.4` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:target.4.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:teamwork.1` | Outside the supported product boundary | MARVEL-272 | This rule belongs to deckbuilding, a mode, or a product classification not yet supported. |
| `rr:teamwork.2` | Outside the supported product boundary | MARVEL-272 | This rule belongs to deckbuilding, a mode, or a product classification not yet supported. |
...
| `rr:text-box.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns references that isolate printed abilities in a text box. |
| `rr:text-box.1.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns icons treated as abilities within a text box. |
| `rr:that` | Redirect or summary | — | This record redirects readers to Alteration Effect, Target; the destination carries the rule. |
| `rr:then` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:then.1` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
| `rr:then.2` | Unimplemented behavior | MARVEL-270 | The ability-language work item owns this executable rule. |
...
| `rr:treachery` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:unique-icon.1.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:unique-icon.1.2` | Executable and cited | — | A behavior test directly cites this record. |
| `rr:unique-icon.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:unique-icon.2.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:unique-icon.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:unique-icon.3.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:unique-icon.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:unique-icon.4.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:unique-icon.4.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:upgrade` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:upgrade.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:upgrade.2` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:upgrade.3` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:upgrade.3.1` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
| `rr:upgrade.4` | Unimplemented behavior | MARVEL-269 | No test directly cites this decision; MARVEL-269 owns the existing-behavior check and narrow citation. |
...
| `rr:villain-phase.step.2.b` | Executable and cited | — | A behavior test directly cites this record. |
