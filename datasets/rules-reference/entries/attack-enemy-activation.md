...
1. Enemy attacks are always initiated against both a player and a character.
    ...
    <a id="attack-enemy-activation-1-8"></a>
    - If a hero has been declared the defender of the attack, reduce the amount of damage dealt by that hero’s DEF value. 5. **Deal damage:** Deal the amount of damage calculated in the previous step, based on the following:
...
4. If **no character was declared the defender** of the attack, the attack is considered undefended. All damage from the attack is dealt to the character targeted by the attack.
    ...
    - The targeted character is considered to have been attacked. 6. The attack finishes resolving and the following types of abilities trigger in order: a. Forced abilities *(such as the retaliate keyword)* with the following triggers (in any order):
    <a id="attack-enemy-activation-4-2"></a>
    - “after [character] attacks [and damages/defeats] [you/an ally]...”
    <a id="attack-enemy-activation-4-3"></a>
    - “after [character] is attacked...”
    <a id="attack-enemy-activation-4-4"></a>
    - “after [character] defends [and takes no damage]...”
    <a id="attack-enemy-activation-4-5"></a>
    - “after [character] [takes/deals] damage...” b. Non-forced abilities with the triggers listed above. These rules also apply to enemy attacks:
