...
<a id="player-elimination-5"></a>
5. If a player is eliminated partway through the resolution of an ability, resolve the entire ability.
    <a id="player-elimination-5-1"></a>
    - If a player is eliminated in the middle of an attack, that attack ends.

<a id="player-elimination-6"></a>
6. Effects that refer to the players in the game ignore eliminated players, except for the per player icon ([per-player]).

**See also:** [Ability](ability.md), [Deal](deal-deal-an-encounter-card.md), [Engage](engage.md), [Game Element](game-element.md), [Hit Points](hit-points.md), [Identity](identity.md), [Minion](minion.md), [Per Player Icon](per-player-icon.md), [Player](player.md), [Player Card](player-card.md), [Player Deck](player-deck.md), [Player’s Play Area](player-s-play-area.md), [Winning the Game](winning-the-game.md)
