...
<a id="side-scheme-2"></a>
2. A side scheme remains in play until there is no threat on it *(which causes it to be defeated and discarded)*, or until a card ability removes it from play. *(Threat can be removed from side schemes by using the thwart power of heroes and allies, or by using card abilities.)*

**See also:** [Card Types](card-types.md), [Defeat](defeat.md), [Encounter Card](encounter-card.md), [Enters Play](enters-play.md), [Leaves Play](leaves-play.md), [Main Scheme](main-scheme-main-scheme-deck.md), [Threat](threat.md), [Thwart](thwart.md), [Villain’s Play Area](villain-s-play-area.md)
