...
{
    /// <summary>Moves a defeated card with Victory to the victory display.</summary>
    public static bool ToVictoryDisplay(
        World world, ICardFacts facts, Card card, string trigger, List<GameEvent> events) =>
        VictoryDisplay.ToVictoryDisplay(world, facts, card, trigger, events);

    /// <summary>The victory points currently in the victory display.</summary>
    public static long VictoryPoints(World world, ICardFacts facts) =>
        VictoryDisplay.VictoryPoints(world, facts);
        ...
        World world, ICardFacts facts, Card card, string trigger, List<GameEvent> events)
    {
        ...
        switch (kind)
        {
            ...
            case CardKind.Minion:
                ...
                VictoryDisplay.MoveDefeatedCard(world, facts, card, trigger, events);
        ...
        World world, ICardFacts facts, Card scheme, string trigger, List<GameEvent> events)
    {
        ...
        VictoryDisplay.MoveDefeatedCard(world, facts, scheme, trigger, events);
    }
