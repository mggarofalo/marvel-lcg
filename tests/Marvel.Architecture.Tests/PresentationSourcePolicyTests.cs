...
public sealed class PresentationSourcePolicyTests
{
    ...
    public void ViewUsesOnlyReviewedEngineMembers()
    {
        ...
        [
            ...
            "Marvel.Rules.Events.GameEvent.Subjects",
            ...
            "Marvel.Rules.Play.Attack.DefenseVerb",
            ...
            "Marvel.Rules.Prompts.Affordance.AnchorKind",
            ...
            "Marvel.Rules.Prompts.AffordanceAnchorKind.Area",
            "Marvel.Rules.Prompts.AffordanceAnchorKind.Card",
            "Marvel.Rules.Prompts.AffordanceAnchorKind.Unspecified",
            "Marvel.Rules.Prompts.AffordanceAnchorKind.operator !=(Marvel.Rules.Prompts.AffordanceAnchorKind, Marvel.Rules.Prompts.AffordanceAnchorKind)",
            "Marvel.Rules.Prompts.AffordanceAnchorKind.operator ==(Marvel.Rules.Prompts.AffordanceAnchorKind, Marvel.Rules.Prompts.AffordanceAnchorKind)",
            ...
            "Marvel.Rules.State.CardKind.Minion",
            ...
            "Marvel.Rules.State.DeckType.EngagedEnemiesArea",
            "Marvel.Rules.State.DeckType.HandsArea",
            "Marvel.Rules.State.DeckType.HeroArea",
            "Marvel.Rules.State.DeckType.StatusArea",
            ...
            "Marvel.Rules.State.FacedownDrones.BaseValue(Marvel.Rules.State.Card, Marvel.Rules.State.ICardFacts, string, int, long)",
            "Marvel.Rules.State.FacedownDrones.EffectiveFaceId",
            "Marvel.Rules.State.FacedownDrones.Is(Marvel.Rules.State.Card)",
            "Marvel.Rules.State.FacedownDrones.Kind(Marvel.Rules.State.Card, Marvel.Rules.State.ICardFacts)",
            "Marvel.Rules.State.FacedownDrones.Title(Marvel.Rules.State.Card, Marvel.Rules.State.ICardFacts)",
            "Marvel.Rules.State.GameArea.Id",
            "Marvel.Rules.State.GameArea.PlayAreas",
            "Marvel.Rules.State.ICardFacts.Attributes(string)",
            "Marvel.Rules.State.ICardFacts.FormattedText(string)",
            ...
            "Marvel.Rules.State.StateFields.Modified(Marvel.Rules.State.World, Marvel.Rules.State.Card, string, Marvel.Rules.State.ICardFacts, int)",
