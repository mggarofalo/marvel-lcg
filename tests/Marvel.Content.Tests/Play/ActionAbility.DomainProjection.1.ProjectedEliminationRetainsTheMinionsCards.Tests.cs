...
public sealed class ActionAbilityDomainProjectionProjectedEliminationRetainsTheMinionsCardsTests
{
    ...
    public void ProjectedEliminationRetainsTheMinionsCardsAndFinishesThePaidAbility()
    {
        ...
        var(game, world) = Playing(board =>
        {
            ...
            tracer = board.CreateCard("01007", board.AreaOf(DeckType.UpgradesArea, PlayArea.Of(0), minion.ObjectId, cardOwner: 0));
        ...
        var offered = Assert.Single(game.Pending!.Affordances, option => option.AnchorId == action.Card);
    ...
    [InlineData(0, 2)]
    [InlineData(1, 3)]
    public void ProjectedChoicesRemainPlayableAfterSourcePaymentAndDamagePrevention(int choice, long finalDamage)
    {
