...
public sealed class RealCardsGameTests
{
    ...
    /// which is a distribution the player chooses. <c>01165</c> Eviction Notice
    /// is an obligation whose options carry their own costs.
    /// </remarks>
    private static readonly string[] Unwritten = ["01098", "01111", "01165"];
