...
public sealed class ActionAbilityTypedChoicePreviewsChoicePreviewDistinguishesAttackContextTests
{
    [Theory]
    [InlineData(true)]
    [InlineData(false)]
    ...
    public void ChoicePreviewKeepsItsCompiledOverkillFlag(bool overkill)
    {
        ...
        var(runner, fields) = MutableNumericRunner("dealAttackDamage", $$"""{"cards":"chosen","amount":5{{marker}}}""", false, "minionsEngagedWithYou");
        Card? source = null;
        Card? minion = null;
