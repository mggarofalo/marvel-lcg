...
public sealed class ActionAbilityQueryIsolationRepetitionReadsPublishAtTheirLiveBoundaryTests
{
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
    ...
    public void EvaluationRetainsTheSourceIncarnationAcrossAChoice(bool choice)
    {
        ...
        string before = choice ? """{"choose":{"options":[{"heal":{"card":"you","amount":1}},{"heal":{"card":"you","amount":2}}]}},""" : "";
        ...
        {
            source = board.CreateCard(AuthoredCards.Shocker, board.AreaOf(DeckType.EngagedEnemiesArea, PlayArea.Of(0)));
