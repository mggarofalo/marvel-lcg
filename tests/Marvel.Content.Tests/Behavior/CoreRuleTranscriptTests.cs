...
public sealed class CoreRuleTranscriptTests
{
    ...
    public void VillainPhaseBranchesHavePinnedOutcomes()
    {
        ...
        Assert.Equal(
            "3bfbddfa17c0e145b4cf7d22ab3411fd70621eea19bbb960615fbe67991a8ad6",
            results["behavior:rr:defend-defense.5.2:published-result"].Digest);
        Assert.Equal(
        ...
        Assert.Equal(
            ...
            results["behavior:rr:boost-boost-icon.3:published-result"].Digest);
        Assert.Equal(
