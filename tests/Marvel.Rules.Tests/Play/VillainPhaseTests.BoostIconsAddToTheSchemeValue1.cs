...
public sealed class VillainPhaseBoostIconsAddToTheSchemeValueTests : VillainPhaseTestBase
{
    ...
    public void TheBoostCardIsDiscardedWhicheverWayItCounts()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "1")).With("scheme", ("EscalationThreat", "0"));
        var world = Board(printed, players: 1);
        var events = Run(world, printed);
        Assert.Contains(events.OfType<CardsMoved>(), moved => moved.Verb == "Boost" && moved.To.Zone == nameof(DeckType.EncounterDiscardPile) && moved.Cards.Any(landing => world.Cards[landing.Card].FaceId == "boost"));
        Assert.Contains(events.OfType<CardsFlipped>(), flipped => flipped.Verb == "Boost" && flipped.FaceUp);
    }
    ...
    public void TheFirstPlayerTokenGoesToTheNextSeat()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "0")).With("scheme", ("EscalationThreat", "0"));
    ...
    public void TheVillainActivatesOncePerPlayer()
    {
        ...
        Assert.Equal(3, events.OfType<CardsMoved>().Count(moved => moved.Verb == "Boost" && moved.To.Zone == nameof(DeckType.BoostCardsDeck)));
    }
    ...
    public void EliminatingAPlayerDoesNotSkipTheNextPlayersVillainActivation()
    {
        ...
        var printed = new Printed().With("villain", ("ATK", "1")).With("identity", ("HP", "10"), ("DEF", "0")).With("scheme", ("EscalationThreat", "0")).With("boost", ("Boost", "0"));
        ...
        for (int answered = 0; asked is not null; answered++)
        {
            ...
            Sequence.Answer(world, printed, activations, asked, Decision.Decline, events);
    ...
    public void TokenPoolsSurviveLeavingPlay()
    {
        ...
        var world = Board(printed, players: 1);
        var card = world.AreaOf(DeckType.EncounterDeck).Cards.Single(c => c.FaceId == "encounter");
    ...
    public void AVillainFacingAHeroAttacksRatherThanSchemes()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "1"), ("ATK", "2")).With("scheme", ("EscalationThreat", "0")).With("identity", ("HP", "10"), ("DEF", "3"));
        printed.Kinds["identity"] = CardKind.Hero;
        var world = Board(printed, players: 1);
        ...
        Run(world, printed);
        Assert.False(world.TheCardIn(DeckType.MainSchemesArea)!.Tokens.ContainsKey("k_threat"));
    ...
    public void EachEngagedMinionActivatesAfterTheVillain()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "2")).With("minion", ("SCH", "3")).With("scheme", ("EscalationThreat", "0")).With("boost", ("Boost", "0"));
        var world = Board(printed, players: 1);
    ...
    public void TheEngagedPlayerOrdersTheirMinionActivations()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "0")).With("first", ("SCH", "1")).With("second", ("SCH", "2")).With("scheme", ("EscalationThreat", "0")).With("boost", ("Boost", "0"));
        var world = Board(printed, players: 1);
        var first = world.CreateCard("first", world.AreaOf(DeckType.EngagedEnemiesArea, PlayArea.Of(0)));
        var second = world.CreateCard("second", world.AreaOf(DeckType.EngagedEnemiesArea, PlayArea.Of(0)));
    ...
    public void AMinionEngagedDuringActivationsJoinsTheCurrentProcedure()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "2")).With("arriving", ("SCH", "3")).With("scheme", ("EscalationThreat", "0")).With("boost", ("Boost", "0"));
        var world = Board(printed, players: 1);
    ...
    public void AMinionLeavingPlayCancelsTheRestOfItsSchemeBeforeMoreWindowsOpen()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "0")).With("minion", ("SCH", "3")).With("scheme", ("EscalationThreat", "0")).With("boost", ("Boost", "0"));
        var world = Board(printed, players: 1);
        var minion = world.CreateCard("minion", world.AreaOf(DeckType.EngagedEnemiesArea, PlayArea.Of(0)));
        world.Agenda.Abandon();
        world.Agenda.Add(new PhaseStep(Steps.Scheme, 1, 2, Subject: minion.ObjectId, Seat: 0));
    ...
    public void ARevealedMinionEntersPlayEngagedRatherThanBeingDiscarded()
    {
        ...
        var printed = new Printed().With("villain", ("SCH", "0")).With("scheme", ("EscalationThreat", "0")).With("boost", ("Boost", "0"));
        var world = Board(printed, players: 1);
    ...
    [InlineData(3, 2, true)]
    public void AMainSchemeCompletesAtItsTargetAndNotOnlyPastIt(int escalation, int target, bool completes)
    {
        var printed = new Printed().With("villain", ("SCH", "0")).With("scheme", ("EscalationThreat", escalation.ToString()), ("TargetThreat", target.ToString()));
        var world = Board(printed, players: 1);
        Run(world, printed);
